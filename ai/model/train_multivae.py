...
for epoch in range(1, args.n_epochs + 1):
    ...
    val_loss, n100, r10, r20 = evaluate(model, criterion, valid_in_data, valid_out_data, is_VAE=True)
    print('-' * 89)
...
torch.save(model.state_dict(), args.save_dir + '/multivae.pth')

# Run on test data.
test_loss, n100, r10, r20 = evaluate(model, criterion, valid_in_data, valid_out_data, is_VAE=True)
print('=' * 89)
