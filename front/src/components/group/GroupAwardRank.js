...
import '../../scss/GroupAward.scss'
import { Divider } from 'antd';

export default function GroupAwardBanner () {
  return (
      ...
      <div className="award-rank">
        <article className="leaderboard">
          ...
          <main className="leaderboard__profiles">
            ...
            <img src="/img/rank_1.gif" alt="Dustin Moskovitz" className="leaderboard__picture" />
              <span className="leaderboard__name">aaaaaaaaaa</span>
              <span className="leaderboard__value">35<span>개</span></span>
            </article>

            <article className="leaderboard__profile">
            <img src="/img/rank_2.gif" alt="Dustin Moskovitz" className="leaderboard__picture" />
              <span className="leaderboard__name">aaaaaaaaaa</span>
              <span className="leaderboard__value">9<span>개</span></span>
            </article>

            <article className="leaderboard__profile">
            <img src="/img/rank_3.gif" alt="Dustin Moskovitz" className="leaderboard__picture" />
              <span className="leaderboard__name">aaaaaaaaaa</span>
        ...
        <article className="leaderboard">
          <div className='leaderboard-header'>
            <img src="/img/trophy-48.png" className='leaderboard__icon' alt="ssss" />
            <h1 className="leaderboard__title"><span className="leaderboard__title--top">문제풀이왕</span><span className="leaderboard__title--bottom">추가내용</span></h1>
          </div>
