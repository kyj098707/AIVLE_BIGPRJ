          ...
          <Container style={{ padding: "0", margin: "0" }}>
            <Row>
              <Col sm style={{ marginRight: "5%" }}>
                ...
                <h4>이유는 다릅니다.</h4>
                <p>
                  산타는 사용자가 어떤 문제를 왜 틀렸는지 95%의 정확도로
                  측정합니다.현재 지식 수준을 가장 잘 평가할 수 있는 12개의
                  문제들로 실력을 진단하고,실시간 학습 데이터를 분석해 최적의
                  학습 경로를 탐색합니다.
                </p>
              </Col>
              <Col sm style={{ marginRight: "5%" }}>
                ...
                <h4>점수가 오르진 않습니다.</h4>
                <p>
                  점수를 올리는 방법은 다양합니다. 취약점 보완 뿐만
                  아니라,실수하는 부분을 연습하는 것, 강점을 최대화하는 것도
                  방법입니다. 산타가 제안하는 가장 효과적인 방법으로 빠르게 목표
                  점수를 달성하세요.
                </p>
              </Col>
              <Col sm style={{ marginRight: "5%" }}>
                ...
                <h4>점수를 향상 시키세요.</h4>
                <p>
                  산타는 단 하나의 ID로 모바일, 태블릿, PC 등 모든 장치에서
                  접속할 수 있어 끊김없는 학습이 가능합니다. 무작정 문제집이나
                  강의를 정복하는 대신, 목표점수를 달성하는 데 꼭 필요한 문제와
                  강의에 집중해 보세요.
                </p>
              </Col>
            </Row>
